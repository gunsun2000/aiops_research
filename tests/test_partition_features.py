...
from orchestrator_agent.partition_context import WorkloadForecast
...
from orchestrator_agent.partition_ranking import CandidateRanker, RankingContext
from orchestrator_agent.partition_ranking_models import CandidateSelection
...
class _ForecastCapturingRanker(CandidateRanker):
    ...
    def rank(self, context: RankingContext, candidates) -> CandidateSelection:
        ...
        from orchestrator_agent.partition_ranking import DeterministicPolicyRanker
