(function () {
  ...
  function injectPolishStyles() {
    ...
    style.textContent = `
      ...
      .result-search-shell{display:flex;align-items:center;gap:10px;margin:0 0 14px;padding:12px 14px;border:1px solid var(--reference-line);border-radius:8px;background:#fff}.result-search-shell::before{content:"⌕";font-size:20px;color:#718099}.result-search-shell label{display:block;flex:1}.result-search-shell input{height:40px;border:0;padding:0;outline:0}.result-search-shell input:focus{box-shadow:none}.experiment-id-search{font-size:13px}
      ...
      .detail-header{align-items:center}.detail-header>strong{color:#69778f;font-size:12px;font-weight:550}.detail-header-actions{gap:8px}.detail-summary{min-height:530px}.success-hero{padding:26px 18px;border-radius:8px;background:#eefaf5;border:1px solid #d5f1e4}.success-hero strong{color:#087a46}
      .aiopslab-tool-panel{min-height:380px}.benchmark-metric-grid>div{min-height:74px}.benchmark-scenario-card{min-height:72px}
      @media(max-width:1050px){.platform-shell{grid-template-columns:220px minmax(0,1fr)}.view-container{padding:20px}.aiopslab-reference-grid{grid-template-columns:1fr}.selected-summary{position:static}.reference-recovery-setup{grid-template-columns:1fr}}
